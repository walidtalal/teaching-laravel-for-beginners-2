...
<?php $__env->startSection('home-active', 'active'); ?>
    ...
    <div class="container-xxl bg-primary hero-header">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-start">
                    <img class="img-fluid animated zoomIn" src="<?php echo e(asset('assets-front')); ?>/img/hero.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
                ...
                <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                    <img class="img-fluid mt-5" style="max-height: 250px;"
                         src="<?php echo e(asset('assets-front')); ?>/img/newsletter.png">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-xxl bg-primary my-6 py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="owl-carousel client-carousel">
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-1.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-2.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-3.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-4.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-5.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-6.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-7.png"
                                 alt=""></a>
                <a href="#"><img class="img-fluid" src="<?php echo e(asset('assets-front')); ?>/img/logo-8.png"
                                 alt=""></a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/front/index.blade.php ENDPATH**/ ?>