...
<head>
    ...
    <title><?php echo e(__('keywords.dashboard')); ?> - <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Simple bar CSS -->
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Icons CSS -->
    <link rel="stylesheet" href="<?php echo e(asset($dir)); ?>/css/feather.css">
...
<?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/admin/partials/head.blade.php ENDPATH**/ ?>