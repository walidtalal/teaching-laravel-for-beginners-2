<?php $__env->startSection('title', __('keywords.index')); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    <div class="col">
                        <h2 class="h5 page-title"><?php echo e(__('keywords.welcome')); ?>!</h2>
                    </div>
                    <div class="col-auto">
                            ...
                            <div class="card-body" data-simplebar
                                ...
                                <div class="pb-3 timeline-item item-warning">
                                    <div class="pl-5">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col"><img
                                                    src="<?php echo e(asset('assets-admin')); ?>/assets/products/p1.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                            <div class="col"><img
                                                    src="<?php echo e(asset('assets-admin')); ?>/assets/products/p2.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                            <div class="col"><img
                                                    src="<?php echo e(asset('assets-admin')); ?>/assets/products/p3.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                            <div class="col"><img
                                                    src="<?php echo e(asset('assets-admin')); ?>/assets/products/p4.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                        </div>
                                            ...
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                         src="<?php echo e(asset('assets-admin')); ?>/assets/avatars/face-1.jpg">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                         src="<?php echo e(asset('assets-admin')); ?>/assets/avatars/face-4.jpg">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                         src="<?php echo e(asset('assets-admin')); ?>/assets/avatars/face-3.jpg">
                                                </a>
                                            </li>
                                        </ul>
                                        <p class="small text-muted">Front-End Development <span
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/admin/index.blade.php ENDPATH**/ ?>