<?php $__env->startSection('title', __('keywords.add_new_feature')); ?>

<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="h5 page-title"><?php echo e(__('keywords.add_new_feature')); ?></h2>

                <div class="card shadow">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.features.store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                    <input type="text" name="icon" class="form-control"
                                           placeholder="<?php echo e(__('keywords.icon')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal45d822e9eb9a9f889793b0925aab5602 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal45d822e9eb9a9f889793b0925aab5602 = $attributes; } ?>
<?php $component = App\View\Components\ValidationError::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('validation-error'); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/admin/features/create.blade.php ENDPATH**/ ?>