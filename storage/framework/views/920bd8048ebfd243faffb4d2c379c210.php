<?php $__env->startSection('title', __('keywords.messages')); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-3">
                    <h2 class="h5 page-title"><?php echo e(__('keywords.messages')); ?></h2>
                </div>
...
<?php endif; ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('keywords.subject')); ?></th>
                            ...
                            <?php if(count($messages) > 0): ?>
                                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($messages->firstItem() + $loop->index); ?></td>
...
<?php $component = App\View\Components\ActionButton::resolve(['href' => ''.e(route('admin.messages.show', ['message' => $message])).'','type' => 'show'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\DeleteButton::resolve(['href' => ''.e(route('admin.messages.destroy', ['message' => $message])).'','id' => ''.e($message->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php echo e($messages->render('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/admin/messages/index.blade.php ENDPATH**/ ?>