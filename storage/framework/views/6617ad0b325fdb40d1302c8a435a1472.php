<?php $__env->startSection('title', __('keywords.subscribers')); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-3">
                    <h2 class="h5 page-title"><?php echo e(__('keywords.subscribers')); ?></h2>
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(count($subscribers) > 0): ?>
                                <?php $__currentLoopData = $subscribers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subscriber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($subscribers->firstItem() + $loop->index); ?></td>
...
<?php $component = App\View\Components\DeleteButton::resolve(['href' => ''.e(route('admin.subscribers.destroy', ['subscriber' => $subscriber])).'','id' => ''.e($subscriber->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php echo e($subscribers->render('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/admin/subscribers/index.blade.php ENDPATH**/ ?>