<?php $__env->startSection('title', __('keywords.edit_feature')); ?>

<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="h5 page-title"><?php echo e(__('keywords.edit_feature')); ?></h2>

                <div class="card shadow">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.features.update', ['feature' => $feature])); ?>" method="post"
...
<?php endif; ?>
                                    <input type="text" name="title" class="form-control"
                                           placeholder="<?php echo e(__('keywords.title')); ?>" value="<?php echo e($feature->title); ?>">
...
<?php endif; ?>
                                    <input type="text" name="icon" class="form-control"
                                           placeholder="<?php echo e(__('keywords.icon')); ?>" value="<?php echo e($feature->icon); ?>">
                                    <?php if (isset($component)) { $__componentOriginal45d822e9eb9a9f889793b0925aab5602 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal45d822e9eb9a9f889793b0925aab5602 = $attributes; } ?>
<?php $component = App\View\Components\ValidationError::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('validation-error'); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['field' => 'icon']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal45d822e9eb9a9f889793b0925aab5602)): ?>
<?php $attributes = $__attributesOriginal45d822e9eb9a9f889793b0925aab5602; ?>
<?php unset($__attributesOriginal45d822e9eb9a9f889793b0925aab5602); ?>
...
<?php unset($__componentOriginal54c611f5808eb808c122f307874dfe3a); ?>
<?php endif; ?>
                                    <textarea name="description" class="form-control" placeholder="<?php echo e(__('keywords.description')); ?>"><?php echo e($feature->description); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginal45d822e9eb9a9f889793b0925aab5602 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal45d822e9eb9a9f889793b0925aab5602 = $attributes; } ?>
<?php $component = App\View\Components\ValidationError::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('validation-error'); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-for-beginners-2\resources\views/admin/features/edit.blade.php ENDPATH**/ ?>